...
public class Rule1ConstraintCheck {
	...
	public boolean isCompareOperator(String operator){
		...
		if(Constants.V_GREATT.equals(operator) || Constants.V_GREATTE.equals(operator) || Constants.V_LESST.equals(operator) || Constants.V_LESSTE.equals(operator) || Constants.V_EQUAL.equals(operator)){
			result = true;
		}
		return result;
	}
